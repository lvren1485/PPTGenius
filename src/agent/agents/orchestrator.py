...
class Orchestrator:
    ...
    def run(
        ...
        if not outline_data or not outline_data.get("slides"):
            from ..models.outline import SlideOutline
            outline_data = {
                "topic": topic,
                "slides": [
                    SlideOutline(title=topic, subtitle="Generated by PPTGenius", layout_type="title"),
                    SlideOutline(title="Overview", bullets=["Introduction to " + topic, "Key concepts", "Applications"], layout_type="content"),
                    SlideOutline(title="Summary", subtitle="Thank You", layout_type="ending"),
                ],
            }
