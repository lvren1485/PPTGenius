...
大纲生成管线经历了三个版本的迭代，每次迭代都带来了实际的生成时间缩减：7-8 分钟 → 4-5 分钟 → 2-3 分钟。相比 PPT 生成管线（7-8 分钟 → 4-6 分钟，且不稳定），大纲管线的优化效果更为显著。
...
| V3 Explore + Generator | **2-3 min** | 4-6 min | Explore 搜索 (仅一次) |
