...
| 指标 | 值 |
|------|------|
| 每行代码现金成本 | 198.30 / 14,200 ≈ **0.014 元/行** |
| 每行代码工时 | 368h / 14,200 ≈ **1.6 分钟/行** |
...
| 参数 | 值 |
|------|------|
| 有效代码量 (KLOC) | 14.2 (不含旧代码、测试) |
| a (organic) | 2.4 |
| b (organic) | 1.05 |
| 估算工时 | 2.4 × 14.2^1.05 ≈ 38 人月 |
| 实际工时 | 368h ÷ 160h/月 ≈ 2.3 人月 |

COCOMO 估算是实际的 **16.5 倍**。差异原因：
...
| 指标 | 值 | 行业参考 |
|------|------|---------|
| 代码产出率 | 14,200 / 368h ≈ **39 行/人时** | 传统: 10-20 行/人时 |
| 功能点/人月 | 25 / 2.3 ≈ **11 FP/人月** | 传统: 5-10 FP/人月 |
| 缺陷密度 | 2 CRITICAL (已修复) / 14.2 KLOC ≈ **0.14/KLOC** | 行业: 1-25/KLOC |
| 测试密度 | 150 tests / 14.2 KLOC ≈ **10.6 tests/KLOC** | |
